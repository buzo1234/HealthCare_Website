...
<!-- Features -->
<section class="class41">
  <div class="class42">
    <div class="class43">
      <p class="py-3 px-2 text-lg">Order Medicines</p>
      <img src="https://assets.pharmeasy.in/web-assets/dist/7c645a8d.png?dim=186x0&dpr=1.25&q=100" alt="" class="class44">
    </div>
    <div class="px-2 py-3">
  ...
  <div class="col-span-1 shadow-xl rounded-lg">
    <div class="class43">
      ...
      <img src="https://assets.pharmeasy.in/web-assets/dist/c7c7095b.png?dim=186x0&dpr=1.25&q=100" alt="" class="class44">
    </div>
    <div class="px-2 py-3">
  ...
  <div class="col-span-1 shadow-xl rounded-lg">
    <div class="class43">
      ...
      <img src="https://assets.pharmeasy.in/web-assets/dist/e1d3ac1c.png?dim=186x0&dpr=1.25&q=100" alt="" class="class44">
    </div>
    <div class="px-2 py-3">
      ...
      if($result = $mysqli->query($sql)){
        if($result->num_rows > 0){
          while($row = $result->fetch_assoc()){
            echo "<a href='./category.php?cat_id={$row['cat_id']}' class='class47'><div class='flex flex-col'>
